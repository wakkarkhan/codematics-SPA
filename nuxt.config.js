  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileImage', content: '/favicons/144.png' },
      // PWA primary color
    ...
    link: [
      // Favicon
      { rel: 'shortcut icon', href: '/favicons/16.png' },
      { rel: 'apple-touch-icon', sizes: '57x57', href: '/favicons/57.png' },
      { rel: 'apple-touch-icon', sizes: '60x60', href: '/favicons/60x60.png' },
      ...
      { rel: 'apple-touch-icon', sizes: '120x120', href: '/favicons/120.png' },
      { rel: 'apple-touch-icon', sizes: '144x144', href: '/favicons/144.png' },
      { rel: 'apple-touch-icon', sizes: '152x152', href: '/favicons/152.png' },
      { rel: 'apple-touch-icon', sizes: '182x182', href: '/favicons/182.png' },
